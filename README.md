...
Многопоточный http.net сервер версия 1.1, (C) kornienko.ru февраль 2023.
...
Тестирование показало, что при количестве одновременных запросов около 1 тыс. и более скорость ответа падает примерно на 0,5 сек. В планах добавление кеширования запрашиваемых файлов с целью увеличения скорости работы сервера.
