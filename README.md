...
Многопоточный http.net сервер версия 1.2, (C) kornienko.ru апрель 2023.
...
1.2. Апрель 2023. Реализовано сохранения буферов журнала запросов при бездействии сервера в течении 1 с.
