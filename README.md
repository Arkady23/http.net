...
Multithreaded http.net server version 2.6.2, (C) a.kornienko.ru November 2024.
...
2.5.2-2.5.3. November 2024. Added syntactic control of the query method. The value of the response duration in ms has been added to the log, the symbol "-" when the server refuses to process the request, and some other changes in the log.  
